@extends('layouts.master')
    ...
    @section('title' , 'Admin|Rebuilt Issue, Add new')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.rebuilt.issue.store')}}" enctype="multipart/form-data">
                                    @csrf
