@extends('layouts.master')
    ...
    @section('title' , 'Admin|Accident Repair, Add new')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.accident.repair.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    
                                    
                                <h6>Accident Repair, Add New</h6>
                                <hr>    
                                
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        <label for="project_name" >Maint Type</label>
                                       <input type="text" class="form-control" value="Accident Reapir" name="maint_type" readonly>      
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('acc_ref') is-invalid @enderror" id="pay_ref" name="acc_ref" placeholder="Accident Ref">
                                    </div>
                                    <div class="form-group col-lg-4">
                                ...
                                <div class="item form-group">
                                    <div class="col-md-6 col-sm-6 ">
                                        <a class="btn btn-primary" href="{{route('admin.general.repair')}}">Back</a>
