@extends('layouts.master')
    ...
    @section('title' , 'Admin|Company Branch Create')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.company.branch.save')}}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('branch_eid') is-invalid @enderror" id="branch_eid" name="branch_eid" placeholder="Branch EID">
                                            @error('branch_eid')
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('branch_name') is-invalid @enderror" id="branch_name" name="branch_name"placeholder="Branch Name">
                                        @error('branch_name')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
                                            ...
                                            <select class="form-control select2" id="country" data-placeholder="Select Branch" name ="branch_type" style="width: 100%;">
                                                @if(count($branches) > 0)
                                                    @foreach($branches as $branch)
                                                        <option value="{{$branch->id}}" >{{$branch->branch_type}}</option>
                                                    @endforeach
                                                @endif
                                            </select> 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="email" class="form-control  @error('branch_email') is-invalid @enderror" id="branch_email" name="branch_email"placeholder="Branch Email">
                                        @error('branch_email')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('branch_contact') is-invalid @enderror" id="branch_contact" name="branch_contact"placeholder="Branch Contact">
                                            ...
                                            <select class="form-control select2" id="company_id" data-placeholder="Select Company Id" name ="company_id" style="width: 100%;">
                                                @if(count($companies) > 0)
                                                    @foreach($companies as $company)
                                                        <option value="{{$company->id}}" >{{$company->company_eid}}</option>
                                                    @endforeach
                                                @endif
                                            </select> 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" class="form-control  @error('street') is-invalid @enderror" id="street_1" name="street" placeholder="Street">
                                            @error('street')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
