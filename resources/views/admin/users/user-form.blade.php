                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin-area.user-save')}}">
                                    @csrf
                                    ...
                                    <div class="item form-group">
                                        ...
                                        @if(count($roles) > 0)
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" class="flat" name=roles[]  checked="checked" value="{{$role->id}}"> {{$role->label}}
                                                </label>
                                            </div>
                                            @endforeach
                                        @endif
