@extends('layouts.master')
    ...
    @section('title' , 'Admin|Regular Maintenance, Add new')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.regular.maintenance.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    
                                    
                                <h6>Regular Maintenance, Add New</h6>
                                <hr>    
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        @if(count($fleetTypes) > 0)
                                            ...
                                            <option value="{{$f->id}}" data-id="{{$f->id}}" {{old ('fleet') == $f->id ? 'selected' : ''}}>{{$f->fleet_type}}</option>
                                            @endforeach
                                        @endif
                                        </select>    
                                        @error('fleet')
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        @if(count($vehicleTypes) > 0)
                                            ...
                                            <option value="{{$vt->id}}"  {{old ('type') == $vt->id ? 'selected' : ''}}>{{$vt->vehicle_type}}</option>
                                            @endforeach
                                        @endif
                                        </select>    
                                        @error('fleet')
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <select class="form-control select2 @error('maint_type') is-invalid @enderror" id="maint_type" data-placeholder="Select Maint Type" name ="maint_type" style="width: 100%;">
                                            <option value="" >Select Maint Type</option>
                                            @if(count($services) > 0)
                                                @foreach($services as $vt)
                                                <option value="{{$vt->id}}">{{$vt->service_type}}</option>
                                                @endforeach
                                            @endif
                                        </select>  
                                        @error('maint_type')
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="text" class="form-control  @error('meter') is-invalid @enderror" id="meter" name="meter" placeholder="Meter R">
                                        @error('meter')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="text" class="form-control  @error('po') is-invalid @enderror" id="po" name="po" placeholder="po No.">
                                        @error('po')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="number" class="form-control  @error('cost') is-invalid @enderror" id="cost" name="cost" placeholder="Cost">
                                        @error('cost')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        @if(count($suppliers) > 0)
                                            ...
                                            <option value="{{$vt->id}}">{{$vt->supplier_name}}</option>
                                            @endforeach
                                        @endif
                                        </select>    
                                        @error('supplier')
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('remark') is-invalid @enderror" id="remark" name="remark" placeholder="Remarks">
                                    </div>
                                ...
                                <div class="item form-group">
                                    <div class="col-md-6 col-sm-6 ">
                                        <a class="btn btn-primary" href="{{route('admin.regular.maintenance')}}">Back</a>
