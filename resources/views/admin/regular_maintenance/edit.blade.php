@extends('layouts.master')
    ...
    @section('title' , 'Admin|Regular Maintenance, Edit')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.regular.maintenance.update')}}" enctype="multipart/form-data">
                                    @csrf
                                    
                                <input type="hidden" name="id" value="{{$regular->id}}">
                                <h6>Regular Maintenance, Edit</h6>
                                <hr>    
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <select class="form-control select2 @error('maint_type') is-invalid @enderror" id="maint_type" data-placeholder="Select Maint Type" name ="maint_type" style="width: 100%;">
                                            ...
                                            @if(count($services) > 0)
                                                ...
                                                <option value="{{$vt->id}}" {{$regular->maintenance_type == $vt->id ? 'selected' : ''}}>{{$vt->service_type}}</option>
                                                @endforeach
                                            @endif
                                        </select>  
                                        @error('maint_type')
