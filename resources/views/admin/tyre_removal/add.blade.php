@extends('layouts.master')
    ...
    @section('title' , 'Admin|Tyre Removal, Add new')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.tyre.removal.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    
                                    
                                <h6>Tyre Removal, Add New</h6>
                                <hr>    
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="number" class="form-control  @error('unit_cost') is-invalid @enderror" id="unit_cost" name="unit_cost" placeholder="Unit Cost">
                                        @error('unit_cost')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
