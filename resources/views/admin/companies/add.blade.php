@extends('layouts.master')
    ...
    @section('title' , 'Admin|Company Create')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.company.save')}}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('company_eid') is-invalid @enderror" id="company_eid" name="company_eid" placeholder="Company EID">
                                            @error('company_eid')
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('company_phone_number') is-invalid @enderror" id="phone_number" name="company_phone_number" placeholder="Company Phone Number">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" class="form-control  @error('street') is-invalid @enderror" id="street_2" name="street_2" placeholder="Street 2">
                                            @error('street_2')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control  @error('postal_code') is-invalid @enderror" id="postal_code" name="postal_code" placeholder="Zip Code">
                                            @error('postal_code')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
