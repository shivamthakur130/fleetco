@extends('layouts.master')
    ...
    @section('title' , 'Admin|Other Renewal Create')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.other.renewal.save')}}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control select2 @error('renewal') is-invalid @enderror" id="renewal" data-placeholder="Select Fleet" name ="renewal" style="width: 100%;">
                                            ...
                                            @if(count($renewals) > 0)
                                                ...
                                                <option value="{{$renewal->id}}" >{{$renewal->renewal}}</option>
                                                @endforeach
                                            @endif
                                            </select>     
                                        @error('renewal')
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control  @error('cost') is-invalid @enderror" id="cost" name="cost" placeholder="Cost">
                                    </div>
