                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.rebuilt.receipt.store')}}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input class="form-control select2 " id="po" placeholder="PO Reference" name ="po" style="width: 100%;" />
