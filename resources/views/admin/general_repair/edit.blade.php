@extends('layouts.master')
    ...
    @section('title' , 'Admin|General Repair, Edit')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.general.repair.update')}}" enctype="multipart/form-data">
                                    @csrf
                                    
                                <input type="hidden" name="id" value="{{$regular->id}}">
                                <h6>General Repair, Edit</h6>
                                <hr>    
