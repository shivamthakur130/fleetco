@extends('layouts.master')
    ...
    @section('title' , 'Admin|General Repair, Add new')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.general.repair.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    
                                    
                                <h6>General Repair, Add New</h6>
                                <hr>    
                                
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        <label for="project_name" >Maint Type</label>
                                       <input type="text" class="form-control" value="General Reapir" name="maint_type" readonly>      
                                    </div>
