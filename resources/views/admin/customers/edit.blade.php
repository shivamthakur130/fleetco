                            ...
                            <div class="x_content">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label for="project_url" >Country</label>
                                            <select class="form-control select2" id="country" data-placeholder="Select Country" name ="country" style="width: 100%;">
                                                ...
                                                <option value="{{$country->id}}" @if($country->id == $customer->country) selected @endif>{{$country->name}}</option>
                                                @endforeach
                                                @endif
                                            </select> 
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" value="{{$customer->phone}}" placeholder="Phone Number">
                                        @error('phone_number')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
