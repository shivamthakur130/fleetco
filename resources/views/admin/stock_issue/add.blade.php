@extends('layouts.master')
    ...
    @section('title' , 'Admin|Stock Issue, Add new')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.stock.stock-issue.store')}}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input class="form-control select2 " id="type" value="Issue" data-placeholder="Select Fleet" name ="type" style="width: 100%;" readonly/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="text" class="form-control  @error('remark') is-invalid @enderror" id="remark" name="remark" placeholder="remark">
                                        @error('remark')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="number" class="form-control  @error('rate') is-invalid @enderror" id="rate" name="rate" placeholder="Rate">
                                        @error('rate')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="item form-group">
                                    <div class="col-md-6 col-sm-6 ">
                                        <a class="btn btn-primary" href="{{route('admin.stock.stock-issue')}}">Back</a>
