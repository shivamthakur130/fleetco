@extends('layouts.master')
    ...
    @section('title' , 'Admin|Stock Issue, Edit')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{route('admin.stock.stock-issue.update')}}" enctype="multipart/form-data">
                                    @csrf
                                    
                                <input type="hidden" name="id" value="{{$issue->id}}">  
                                <h6>Stock Issue, Edit</h6>
                                <hr>    
